...
<div class="container">
    <div class="container"><!-- 수정할 부분 naver->get -->
	...
	<h2>"<%=request.getParameter("search")%>" 검색 결과</h2>
  ...
  <div class="container">
    ...
    <table class="table table-hover">
      <h1>공지사항</h1>
      <h3 style="float: right;"><a href="notice">더보기</a></h3>
      <tr>
        <th scope="row">23년 수영장 일정 공지</th>
        <td>관리자</td>
        <td>2022-11-01</td>
    ...
    <table class="table table-hover`">
      <h1>이벤트</h1>
      <h3 style="float: right;"><a href="event">더보기</a></h3>
      <tr>
