...
<link rel="stylesheet" href="/ycc/resources/css/bootstrap.min.css">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
      <!-- 로고 이미지 -->
      <a href="#"><img src="/ycc/resources/img/main_img/logo.png" alt="Young문화센터로고" class="logo" style="width: 40px; height: 40px;"></a>
