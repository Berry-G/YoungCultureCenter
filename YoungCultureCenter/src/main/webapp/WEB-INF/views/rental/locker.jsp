    ...
    <form class="form w-100 h-50 p-2 px-4">
      ...
      <div class="row">  
        ...
        <div class="row">
          ...
          <div class="col-md-2 mb-3 center text-center" >
    ...
    <div class="row">
      <div class="col-md-2">
        <div class="fs-4 pt-3 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="fill: #1971fd;"
      ...
      <div class="col-md-2">
        <div class="fs-4 pt-3  mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="fill: #4f565d" class="bi bi-square-fill"
            viewBox="0 0 16 16">
            <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z"></path>
          </svg>
          사용중
      ...
      <div class="col-md-2">
        <div class="fs-4 pt-3  mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="fill: #1d8956;"
            class="bi bi-square-fill" viewBox="0 0 16 16">
            <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z"></path>
          </svg>
          선택
